...
export const EditorialSection: React.FC = () => {
  ...
  return (
    <section id="editorial" className="relative bg-transparent text-veyra-text border-t border-veyra-border overflow-hidden">
      {/* Container with matching architectural grid borders */}
      <div className="max-w-7xl mx-auto border-x border-veyra-border bg-veyra-bg/80 backdrop-blur-sm relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12">
          {/* Left Column: Manifesto & Philosophy (Matching 00:07 in video) */}
          <div className="lg:col-span-7 p-8 sm:p-12 lg:p-16 border-b lg:border-b-0 lg:border-r border-veyra-border flex flex-col justify-between">
            <div>
              ...
              <div className="space-y-6 text-sm text-veyra-muted leading-relaxed max-w-xl font-normal">
                <p>
            ...
            <div className="pt-12">
              ...
              >
                ...
                <div className="w-9 h-9 rounded-full border border-veyra-border group-hover:border-veyra-text flex items-center justify-center transition-all duration-300 group-hover:translate-x-1">
          ...
          <div className="lg:col-span-5 flex flex-col">
            ...
            <div className="p-8 sm:p-12 border-b border-veyra-border flex flex-col justify-between flex-1 hover:bg-veyra-surface transition-colors">
            ...
            <div className="p-8 sm:p-12 flex flex-col justify-between flex-1 hover:bg-veyra-surface transition-colors">
              <div className="flex justify-between items-baseline">
                <h3 className="font-editorial text-3xl sm:text-4xl text-veyra-text font-normal tracking-wide">
                  Lifetime Guarantee
                </h3>
              ...
              <div className="mt-6 flex flex-col gap-1">
                ...
                <span className="text-[0.625rem] tracking-[0.2em] font-mono text-veyra-faint uppercase pt-2">
